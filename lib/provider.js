...
export default function () {
    ...
    function $get($log, $ionicConfig, $rootScope, $timeout, $state, $location, $ionicHistory, $ionicPlatform) {
        ...
        function stateGo(state = null, stateParams = {}, stateOptions = {}, transitionOptions = null) {
            ...
            unregisterToStateChangeStartEvent();
            transition(transitionOptions, () => $timeout(() => $state.go(state, stateParams, stateOptions)));
            return;
        }
        ...
        function transition() {
            ...
            window.plugins.nativepagetransitions[type](
                options,
                transitionSuccess.bind(this, getTransitionDuration(options), callback),
                transitionError.bind(this, getTransitionDuration(options), callback)
            )
        }
